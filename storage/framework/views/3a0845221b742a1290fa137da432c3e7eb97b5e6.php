...
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/librerias/Select2/css/select2.css')); ?>">
<style>
    #este {
  height: 40em;
  line-height: 1em;
...
<?php echo Form::open(array('id'=>'form_reg_solicitud','autocomplete'=>'off', 'class'=>'border border-5 form-control-sm')); ?>
                                    ...
                                    <div class="form-row " >
                                        ...
                                        <div class="form-group col-md-9">
                                            <select class="form-control-sm custom-select text-uppercase select2 controlEstablecimiento" name="municipio" id="municipio" style="width: 100%">
                                                ...
                                                <?php $__currentLoopData = $municipios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('SolicitudRural.ModalRegistrarPaciente', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>;
<?php echo $__env->make('SolicitudRural.modalListaExamenes', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>;
<?php $__env->stopSection(); ?>

<?php $__env->startSection('scripts'); ?>
<script src="<?php echo e(asset('assets/librerias/jquery-validate/jquery.validate.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('assets/librerias/Select2/js/select2.js')); ?>"></script>
...
<script type="text/javascript" src="<?php echo e(asset('assets/scripts/user/rural/solicitud.js')); ?>"></script>
<script>
 $(document).ready(function() {
    ...
    $('.controlEstablecimiento').change(function() {
        ...
        $.ajax({
            url: "<?php echo e(route('lista.establecimientos.municipios')); ?>",
    ...
    $('.controlCedula').change(function() {
        $.ajax({
            url: "<?php echo e(route('lista.registrados.pacientes')); ?>",
    ...
    $('#BtnPacienteRegistrar').click(function(e) {
        ...
        if ($('#form-registrar-paciente').valid()) {
          $.ajax({
            url:"<?php echo e(route('modal.registrar.paciente')); ?>",
            method:"POST",
     ...
     //PROCESO PARA ADICIONAR LOS DATOS DEL FORMUALRIO A LA TABLA TEMPORAL y VALIDACION DEL FORMULARIO
        ...
        $("#registrar").click(function(e){
            ...
            if (fec_solicitud != '' && municipio != 'Selecione una opcion' && establecimiento != 'Selecione una opcion') {
                ...
                $.ajax({
                    url:"<?php echo e(route('SolicitudRural.store')); ?>",
                    type:'POST',
                    dataType: "html",
                    cache: false,
                    contentType: false,
                   ...
                   // alert(data);
                    if(data=='error_registro_solicitud'){ //resp=='error'	
                        ...
                        /*setTimeout(function(){	
                            window.location="<?php echo e(route('SolicitudRural.index')); ?>";
                        },4000);*/
                    }
...
<?php echo $__env->make("Home.index", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\patologico\resources\views/SolicitudRural/index.blade.php ENDPATH**/ ?>