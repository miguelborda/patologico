...
<?php echo Form::open(array('id'=>'form_reg_ResultadoR','autocomplete'=>'off', 'class'=>'border border-5 form-control-sm')); ?>
...
<script type="text/javascript" src="<?php echo e(asset('assets/scripts/user/rural/resultadoRural.js')); ?>"></script>
<Script  type="text/javascript">
$(document).ready(function() {
    var exiteExamen = 0, exiteDiagnsotico = 0; ; 
     ...
     $('.controlExamen').change(function() {
        $.ajax({
            url: "<?php echo e(route('examens.lista.resultados')); ?>",
     ...
     $('.controlDiagnostico').change(function() {
        $.ajax({
            url: "<?php echo e(route('diagnostico.lista.resultados')); ?>",
     ...
     var i = 1, fila; //contador para asignar id al boton que borrara la fila
        ...
        $("#registrarResult").click(function(e){
            ...
            if (examen != '' && exiteExamen == 0 && fecha_result != '') {
                $.ajax({
                    url:"<?php echo e(route('ResultadoRural.store')); ?>",
                    type:'POST',
                    dataType: "html",
                    cache: false,
                    contentType: false,
                  ...
                  console.log(resp);
                    if(resp=='ok'){ //resp=='error'	
                        ...
                        setTimeout(function(){	
                            window.location="<?php echo e(route('ResultadoRural.index')); ?>";
                        },4000);
                    }
                    else {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("Home.index", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\patologico\resources\views/SolicitudRural/ResultadoR.blade.php ENDPATH**/ ?>