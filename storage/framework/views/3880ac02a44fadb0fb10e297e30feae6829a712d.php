    ...
    <ul class="nav-links">
        ...
        <li>
            ...
            <ul class="sub-menu">
                ...
                <li><a href="<?php echo e(route('SolicitudRural.index')); ?>">Rural Solicitudes</a></li>
                <li><a href="<?php echo e(route('resultado_rural.resultadoR')); ?>">Rural Resultados</a></li>
                <li><a href="<?php echo e(route('test')); ?>">Rural Informes</a></li>
        ...
        <li>
            <div class="profile-details">
                <div class="profile-content">
                    <img src="<?php echo e(asset("assets/img/login/avatar.svg")); ?>" alt="profileImg">
                </div>
                <div class="name-job">
                ...
                <ul class="sub-menu"  style="margin-top: -28px; align: center;">
                    ...
                    <li><a href="<?php echo e(route('logout')); ?>" class="iconlogout">
...
</div><?php /**PATH C:\xampp\htdocs\patologico\resources\views/Home/sidebar.blade.php ENDPATH**/ ?>